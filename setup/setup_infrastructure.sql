...
-- ADWORDS GCLID UPLOAD Database
CREATE DATABASE IF NOT EXISTS ML_LAYER_ADWORDS_GCLID_UPLOAD_DB;
CREATE SCHEMA IF NOT EXISTS ML_LAYER_ADWORDS_GCLID_UPLOAD_DB.PROD;
CREATE STAGE IF NOT EXISTS ML_LAYER_ADWORDS_GCLID_UPLOAD_DB.PROD.ML_LAYER_STAGE
    COMMENT = 'Stage for Adwords GCLID Upload Snowpark deployment artifacts';

...
def get_training_dataset(session: Session, level: Level) -> DataFrame:
    # get config
    ...
    # entity
    svc.set_entity(level.get_join_keys(config.timestamp_col, config.partition_col), recreate=True)
    # feature views
